...
export function AdminConfigMessage({ reason }: Props) {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-xl items-center justify-center bg-slate-50 px-4 py-16 dark:bg-slate-950">
      <div className="w-full rounded-2xl border border-amber-200 bg-amber-50/90 p-8 shadow-lg dark:border-amber-800/50 dark:bg-amber-950/35 dark:shadow-black/40">
        <h1 className="text-xl font-semibold text-amber-950 dark:text-amber-100">
          Configuración del servidor incompleta
        </h1>

        {reason === "session" ? (
          <p className="mt-3 text-sm font-medium text-amber-950/95 dark:text-amber-100/95">
        ...
        {showSession ? (
          <div className="mt-5">
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5 text-sm text-amber-950/85 dark:text-amber-100/85">
              <li>
        ...
        <p className="mt-6 text-xs text-amber-900/70 dark:text-amber-200/75">
